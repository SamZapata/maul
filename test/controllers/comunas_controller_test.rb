...
class ComunasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comuna" do
    assert_difference('Comuna.count') do
      post comunas_url, params: { comuna: { about: @comuna.about, enlace: @comuna.enlace, name: @comuna.name } }
    end
  ...
  test "should update comuna" do
    patch comuna_url(@comuna), params: { comuna: { about: @comuna.about, enlace: @comuna.enlace, name: @comuna.name } }
